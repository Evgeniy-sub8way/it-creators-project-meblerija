...
</li>`}function P(e){const r=document.querySelector(".feedback-list");!r||!e||!e.length||(r.innerHTML=e.map(B).join(""))}window.FeedbackModule={render:P};
